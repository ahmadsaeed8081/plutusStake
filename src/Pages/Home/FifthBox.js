...
const stake3_Contract = {
  address: stake5_address,
  abi: stake2_3_abi,
};
const stakeTokem_Contract = {
  address: Stake5_token_Address,
  abi: token_abi,
};
...
const ThirdBox = ({
  ...
  const { config: appConfig } = usePrepareContractWrite({
    ...
    args: [stake5_address, stakeAmount * 10 ** 18],
  });
  ...
  async function test() {
    ...
    const contract = new web3.eth.Contract(stake2_3_abi, stake5_address);
      ...
      <div className="body-bottom flex flex-col w-full">
        ...
        <div className={`expend-detail flex flex-col ${expend ? "show" : ""}`}>
          ...
          <div className="detail-item flex items-center justify-between">
            ...
            <div className="val-side">
              <a
                href="https://scan.pulsechain.com/address/0x95B303987A60C71504D99Aa1b13B4DA07b0790ab"
                target="_blank"
          ...
          <div className="detail-item flex items-center justify-between">
            ...
            <div className="val-side">
              <a
                href={"https://scan.pulsechain.com/address/" + stake5_address}
                target="_blank"
                className="sub-menu-item"
                style={{ color: "#2498A3" }}
              >
  ...
  return (
    <div className="grid-box flex flex-col">
        ...
        {headerTabsList.map((item, index) => (
          <div
            ...
            className={`header-item flex items-center justify-center ${
              (selectedTab3 === item.title) & (boxNumb === 5) ? "active" : ""
            }`}
            onClick={(e) => {
      ...
      {selectedTab3 === "Stake" ? (
        <div
          className={`box-body flex flex-col ${boxNumb === 5 ? "active" : ""}`}
          onClick={(e) => {
            setSelectedTab3("Stake");
            setBoxNumb(5);
          }}
        >
          {boxNumb !== 5 && <div className="overlay" />}
          <div className="body-top flex items-center justify-between">
            <img src="/images/PulseX_X.png" className="img" />
            <h1 className="top-tag">PLSX</h1>
          </div>
