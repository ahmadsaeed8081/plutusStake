...
const ThirdBox = ({
      ...
      <div className="body-bottom flex flex-col w-full">
        ...
        <div className={`expend-detail flex flex-col ${expend ? "show" : ""}`}>
          ...
          <div className="detail-item flex items-center justify-between">
            ...
            <div className="val-side">
              <a
                href="https://scan.pulsechain.com/address/0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599"
                target="_blank"
          ...
          <div className="detail-item flex items-center justify-between">
            ...
            <div className="val-side">
              <a
                    href={"https://scan.pulsechain.com/address/"+stake4_address}
                    target="_blank"
                className="sub-menu-item"
                style={{ color: "#2498A3" }}
              >
  ...
  return (
    <div className="grid-box flex flex-col">
        ...
        {headerTabsList.map((item, index) => (
          <div
            ...
            className={`header-item flex items-center justify-center ${
              (selectedTab3 === item.title) & (boxNumb === 4) ? "active" : ""
            }`}
            onClick={(e) => {
      ...
      {selectedTab3 === "Stake" ? (
        <div
          className={`box-body flex flex-col ${boxNumb === 4 ? "active" : ""}`}
          onClick={(e) => {
